<div class="subjects index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('max_ca'); ?></th>
			<th><?php echo $this->Paginator->sort('max_exam'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($subject['Subject']['max_ca']); ?>&nbsp;</td>
		<td><?php echo h($subject['Subject']['max_exam']); ?>&nbsp;</td>
		<td><?php echo h($subject['Subject']['date_modified']); ?>&nbsp;</td>
		<td><?php echo h($subject['Subject']['date_created']); ?>&nbsp;</td>
		<td class="actions">
